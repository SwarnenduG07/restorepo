...
// Updated coffee menu items data with proper images from public/menuItems
const menuItems = [
  {
    id: 1,
    name: "Cold Brew Supreme",
    image: "/menuItems/Caramel Macchiato.png",
    category: "COFFEE",
    price: "$5.50",
  ...
  },
  {
    ...
    image: "/menuItems/Chamomile Tea.png",
    category: "COFFEE",
    price: "$4.80",
  ...
  },
  {
    ...
    image: "/menuItems/Chestnut Latte.png",
    category: "COFFEE",
    price: "$5.20",
  ...
  },
  {
    ...
    category: "COFFEE",
    price: "$4.90",
    description: "Perfect foam art with rich espresso"
  },
  {
    id: 5,
    name: "Mocha Supreme",
    ...
    category: "COFFEE",
    price: "$5.60",
    description: "Rich chocolate with premium espresso"
  },
  {
    id: 6,
    name: "Flat White",
    image: "/menuItems/GrapeFruit Ade.png",
    category: "COFFEE",
    price: "$5.30",
    description: "Microfoam with double espresso shot"
  }
];
