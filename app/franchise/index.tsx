...
const franchiseOptions = [
  {
    ...
    description: 'Discover why GrayPipple is the perfect franchise opportunity for passionate entrepreneurs.',
  ...
  },
  {
    ...
    description: 'Understand the investment needed to open your own GrayPipple franchise and the potential returns.',
  ...
  },
  {
    ...
    description: 'Learn about the extensive training and ongoing support we provide to every franchise owner.',
  ...
  },
  {
    ...
    description: 'Read testimonials and success stories from current GrayPipple franchise owners.',
    ...
    <div className="min-h-screen bg-white text-black flex flex-col">
      ...
      <div className="relative w-full h-[500px] bg-green-700">
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-20">
          <div className="max-w-xl">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Own a GrayPipple Franchise</h1>
            <p className="text-xl text-white/90 mb-8">Join our growing family of successful franchise owners and bring premium coffee experiences to your community.</p>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Franchise with GrayPipple?</h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-10">
            GrayPipple offers a unique franchise opportunity with a proven business model, comprehensive support, and an established brand that customers love.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600">Competitive investment with excellent return potential and multiple revenue streams.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600">A tested business model with operational excellence and streamlined processes.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600">Comprehensive training, marketing assistance, and dedicated franchise support team.</p>
            </div>
          </div>
        </div>
        ...
        {/* Franchise Options */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Franchise Information</h2>
          
          <div className="space-y-12">
            {franchiseOptions.map((option, index) => (
              <div 
                key={option.id}
                className={`grid grid-cols-1 md:grid-cols-2 gap-8 items-center rounded-xl overflow-hidden ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}
              >
                <div className={`${option.color} p-8 md:p-16 h-full flex items-center`}>
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold mb-4">{option.title}</h3>
        ...
        <div className="bg-green-700 text-white rounded-xl p-8 md:p-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Join the GrayPipple Family?</h2>
          <p className="text-white/90 max-w-2xl mx-auto mb-8">
            Take the first step toward owning your own successful coffee business. Our franchise team is ready to answer your questions and guide you through the process.
          </p>
      ...
      <footer className="mt-auto bg-gray-900 text-white py-12 px-4">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/franchise?idx=1" className="text-gray-400 hover:text-white">Why GrayPipple</Link></li>
              <li><Link href="/franchise?idx=2" className="text-gray-400 hover:text-white">Investment Details</Link></li>
              <li><Link href="/franchise?idx=3" className="text-gray-400 hover:text-white">Support & Training</Link></li>
              <li><Link href="/franchise?idx=4" className="text-gray-400 hover:text-white">Application Process</Link></li>
              <li><Link href="/franchise?idx=5" className="text-gray-400 hover:text-white">Success Stories</Link></li>
            </ul>
          </div>
